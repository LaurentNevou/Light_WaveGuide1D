...
lambda=5e-6;          %% Wavelength (meter)

neff_min=2;           %% filter the solutions where the effective index is superior than
neff_max=10;          %% filter the solutions where the effective index is inferior than
nmodes=10;            %% number of solutions asked (not activated)
